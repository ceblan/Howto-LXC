...
#+begin_src yaml :tangle ansible/tasks/create-lxc-bananapi.yml
    ...
    - name: Set up LXC container for a bananapi
      ...
      tasks:
        ...
        - name: Ensure /data is mounted in the LXC container
          lineinfile:
        ...
        - name: Delete /home. It will be mounted
          command: lxc-attach -n {{ DEST }} -- sh -c "rm -rf /home"
        ...
        - name: Ensure /home is mounted in the LXC container
          lineinfile:
            path: "/var/lib/lxc/{{ DEST }}/config"
        ...
        - name: Set SSHD to listen on port 353
          lineinfile:
        ...
        - name: Replace line in /var/lib/lxc/{{ DEST }}/rootfs/etc/passwdfor user carlos
          lineinfile:
