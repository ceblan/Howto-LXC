...
---
  - name: Set up LXC container for a pg-node1
    hosts: pindaro # here should be tsc-host-1 instead
    become: yes
    vars_files:
      - vars.yml
    #vars:
    #  DEST: pg-node1  # remove this line if "--extra-vars "DEST=pg-node1" is passed when calling ansible-playbook
